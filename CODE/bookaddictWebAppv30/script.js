/*
BookAddict.com Angular SPA
Authors: Gaurav Gaikwad & Scott Weathered

This script manage bookaddict.com SPA with bookaddict API on localhost Port 8081
...
*/
var bookApp = angular.module('bookAddict.com', ['ngResource', 'ngRoute', 'ngSanitize', 'ngCookies']);
...
bookApp.controller('loginController', ['$rootScope', '$scope', '$http', '$location', '$window', '$cookies','DynamicPageInfoFactory', function ($rootScope, $scope, $http, $location, $window, $cookies,DynamicPageInfoFactory) {
	DynamicPageInfoFactory.update();
	$rootScope.copyrightsText = "Copyrights &copy; 2014, BookAddict. All Rights Reserved.";
...
bookApp.controller('docsController',['$rootScope','$scope', '$http', 'DynamicPageInfoFactory', function($rootScope,$scope,$http,DynamicPageInfoFactory) {
	...
	$scope.docsAPIURL = "http://localhost:8081/bookaddict/v1/";
